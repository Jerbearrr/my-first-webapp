...
<head>
  <title>Manage Books - Add Book</title>
        ...
        <div class="pt-3 sticktodapat d-block d-lg-block" style="box-shadow:none;border-bottom:2px solid #b3b5b7;">
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item advtabs">
              <a href="ManageBookspageAdd.html" class="nav-link active pt-1 pt-lg-3" data-toggle="tab" href="#home">
            ...
            <li class="nav-item advtabs">
              <a href="ManageBookspageEdit.php" class="nav-link  pt-1 pt-lg-3">
